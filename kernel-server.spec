...
%define uname_r		3.1.6-1.1-server%{nil}

%define source_release	1
%define build_release	1%{nil}

%define archive		kernel-server-3.1.6-1.1
...
Source1:		3.1.6-1.1-server-x86_64-defconfig
Source2:		3.1.6-1.1-server-x86-develfiles.list
Source3:		3.1.6-1.1-server-develfiles.list
...
%changelog
* Fri Dec 23 2011 Franck Bui <franck.bui@mandriva.com> 3.1.6-1.1-server
