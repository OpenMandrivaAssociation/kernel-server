...
%define uname_r		3.2.6-1.1-server%{nil}
%define source_release	1
%define build_release	1%{nil}
%define archive		kernel-server-3.2.6-1.1
...
Source1:		3.2.6-1.1-server-x86_64-defconfig
Source2:		3.2.6-1.1-server-x86-develfiles.list
Source3:		3.2.6-1.1-server-develfiles.list
Source4:		3.2.6-1.1-server-output-develfiles.list
...
%changelog
* Tue Feb 14 2012 Franck Bui <franck.bui@mandriva.com> 3.2.6-1.1-server
